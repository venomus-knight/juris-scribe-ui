    ...
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-coffee-gold/30 py-4 px-4 md:px-8">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center">
          <Gavel className="h-6 w-6 text-coffee-medium mr-2" />
          <span className="text-xl font-serif font-semibold text-coffee-dark">LegalPrecedent<span className="text-coffee-medium">AI</span></span>
        </div>
